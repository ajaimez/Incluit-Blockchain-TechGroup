...
const WEB3_PROVIDER = process.env.WEB3_PROVIDER;// Your web3 provider (e.g. geth, Infura) */

var usdtContract =process.env.USDT_CONTRACT;
const contracts = [
  {
    name: 'Token',
...
ethereumEvents.on('block.confirmed', (blockNumber, events, doneCb) => {
  ...
  console.dir(blockNumber);
  console.dir(events);
});

ethereumEvents.on('block.unconfirmed', (blockNumber, events, doneCb) => {
...
const startBlock = process.env.STARTBLOCK; // 6596988;
